<template>
  <div class="app-container">
    ...
    <!-- 数据表格开始 -->
    <el-table v-loading="loading" border :data="speechTableList">
      ...
      <el-table-column label="音频文件" align="center" prop="filepath">
...
<script>
// 引入api
import { listSpeechForPage } from '@/api/recognition/speech'
export default {
  // 定义页面数据
  data() {
    return {
  ...
  methods: {
    ...
    getSpeechList() {
      ...
      listSpeechForPage(this.addDateRange(this.queryParams, this.dateRange)).then(res => {
        this.speechTableList = res.data
